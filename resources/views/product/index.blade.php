                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @if(count($product->image) != 0)
                            ...
                            <img class="img-responsive" src="{{URL::asset($product->image->where('isMain',1)->first()->image)}}" alt="" style="max-width:150px; background-size: contain">                            
                            @else
                            <img class="img-responsive" src="{{URL::asset($product->image->first()->image)}}" alt="" style="max-width:150px; background-size: contain">                            
                            @endif
                        @endif
                        </td>
                        ...
                        <td id="dataCertificate" data-certificate="{{$product->certificate}}">
                            ...
                            <ul>
                                @foreach($product->certificate as $certificate)
                                    <li><a target="_blank" href="{{url('/'.$certificate->certificate)}}">{{$certificate->certificate}}</a></li>
                                @endforeach
                            </ul>
                            @endif
                        </td>
